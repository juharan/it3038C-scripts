...
button_0 = Button(root, text="0", padx=47, pady=20, command=lambda: button_click(0))
button_add = Button(root, text="+", padx=46, pady=20, command=button_add)
button_equal = Button(root, text="Equal", padx=88, pady=20, command=button_equal)
